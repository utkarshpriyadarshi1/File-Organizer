...
def main():
    ...
    pom_path = os.path.join(root_dir, 'backend', 'pom.xml')
    ...
    # Copy config to frontend/src and backend/src/main/resources
    fe_config_dir = os.path.join(root_dir, 'frontend', 'src')
    be_config_dir = os.path.join(root_dir, 'backend', 'src', 'main', 'resources')
    ...
    with open(os.path.join(fe_config_dir, 'app.config.json'), 'w', encoding='utf-8') as f:
        json.dump(config_data, f, indent=2)
    print(f"Copied app.config.json to frontend/src/")
    
    with open(os.path.join(be_config_dir, 'app.config.json'), 'w', encoding='utf-8') as f:
        json.dump(config_data, f, indent=2)
    print(f"Copied app.config.json to backend resources")
