...
:: If there are any packaged Electron installers (like in the root dist directory), sign them as well
if exist "dist" (
    echo Scanning dist for executables/installers...
    ...
    echo [INFO] No packaged executables found to sign in dist\
...
echo ==========================================================
echo - Backend executable: server\target\file-organizer-*.jar
echo - Frontend build folder: ui\build\
echo - Packaged installers: dist\*.exe (Signed, if present)
echo ==========================================================
echo.
pause
