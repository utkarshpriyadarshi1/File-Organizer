...
public class SyncService {
    ...
    public SyncJob createSyncJob(String sourceFolder, String destinationFolder, String syncType) throws Exception {
        SyncJob job = SyncJob.builder()
                .jobName("Sync " + LocalDateTime.now())
                .sourcePath(sourceFolder)
                .destinationPath(destinationFolder)
                .syncType(syncType != null ? syncType.toUpperCase() : "ONE_WAY")
                .status("CREATED")
    ...
    public String runSyncJob(Long jobId) {
        ...
        return backgroundTaskManager.submitTask("SYNC", (taskId, reporter) -> {
            ...
            if ("TWO_WAY".equals(job.getSyncType())) {
