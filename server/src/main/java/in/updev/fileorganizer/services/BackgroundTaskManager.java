...
public class BackgroundTaskManager {
    ...
    public String submitTask(TaskType taskType, String sourcePath, String destinationPath, String actionDetails,
        ...
        if (sourcePath != null || destinationPath != null || actionDetails != null) {
            taskMetaCache.put(taskId, new TaskMeta(sourcePath, destinationPath, actionDetails, null));
        }
    ...
    private void triggerNextTask(TaskType taskType, TaskAction action) {
        executorService.submit(() -> {
            ...
            TaskMeta meta = taskMetaCache.get(finalTaskId);
            if (meta == null) {
                meta = new TaskMeta(null, null, null, startTime);
                taskMetaCache.put(finalTaskId, meta);
            } else {
    ...
    private void handleCancellation(String taskId, TaskType taskType, List<Object> results) {
        ...
        long executionTime = (meta != null && meta.getStartTime() != null) ? (System.currentTimeMillis() - meta.getStartTime()) : 0;
