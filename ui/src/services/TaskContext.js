...
export const TaskProvider = ({ children }) => {
    ...
    const addToast = useCallback((msg, type = "info", metadata = null) => {
        console.log(`[Toast] Added notification (${type}): "${msg}"`);
        ...
        addNotification(msg, title, type, metadata);
    }, [addNotification, antdMessage]);
